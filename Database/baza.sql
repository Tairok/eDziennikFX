CREATE DATABASE  IF NOT EXISTS `school_db` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_polish_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `school_db`;
...
INSERT INTO `classes_tbl` VALUES (1,'Class A'),(2,'Class B'),(3,'Class C');
...
INSERT INTO `grades_tbl` VALUES (1,3,'2023-12-23','Math Test',1,1),(2,4,'2023-12-22','Science Quiz',1,2),(3,1,'2023-12-21','English Assignment',2,3);
...
INSERT INTO `users_tbl` VALUES (1,'John','Doe','john_doe','password123','student',1),(2,'Jane','Smith','jane_smith','securepass','teacher',2),(3,'Admin','Adminson','admin','adminpass','admin',1);
...
-- Dump completed on 2024-01-07 10:58:11
